...
<html lang="en">
  ...
  <div class="row bg-light ">
        <div class="col-lg-3 col-sm-3 col-md-3 mt-3">
            ...
            <a href="../x" class="list-group-item list-group-item-action">Data Pegawai</a>
                <a href="../produksi" class="list-group-item list-group-item-action">Data Produksi</a>
                ...
                <div class="col-12 mr-5">
                    <div class="card shadow">
                        <div class="card-body p-3 ">
                            <h1 class="fs-5 fw-bold my-3 text-center">Divisi Produksi</h1>
                        </div>
                    </div>
                </div>
            </div>
